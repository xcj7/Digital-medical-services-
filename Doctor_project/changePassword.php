...
<input type="password" id="new_password" name="new_password" onkeyup="current_retype()" onblur="checkNewPassword()">
<span class="error" id="new_passwordErr"> <?php echo $new_passwordErr;?></span>

  <div id="txtHint_6"><b></b></div>
  <div id="txtHint_7"><b></b></div>
  <div id="txtHint_8"><b></b></div>
  <br><br>
