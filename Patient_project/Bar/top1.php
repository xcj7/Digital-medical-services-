...
<header>
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="navbar-nav">
      <p class="nav-link"><?php echo "Logged in as ".$_SESSION['Pusername']."||"; ?></p>
      ...
      <a class="nav-link" href="hospital_booking.php"><i class="fas fa-id-badge"></i>Booking</a> 
      <a class="nav-link" href="patient_booked.php"><i class="fas fa-id-badge"></i>Appointment</a>  
      <a class="nav-link" href="patient_booking.php"><i class="fas fa-id-badge"></i>Hospital vacancy</a>
