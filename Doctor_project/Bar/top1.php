...
<header>
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="navbar-nav">
      ...
      <a class="nav-link" href="viewProfile.php"><i class="fas fa-id-badge"></i>Profile</a> 
      <a class="nav-link" href="Patient_booking.php"><i class="fas fa-id-badge"></i>Patient_booking</a> 
      <a class="nav-link" href="patient_booked.php"><i class="fas fa-id-badge"></i>patient_booked</a> 
      <a class="nav-link" href="approved_requests.php"><i class="fas fa-id-badge"></i>approved_requests</a> 
