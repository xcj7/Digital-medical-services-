...
<form method="post"> 
  ...
  <input type="tel" id="Pphone" name="Pphone" pattern="[0-9]{3}[0-9]{8}" value="<?php echo $Pphone ?>" onkeyup="showUser_phonenumber(this.value)" onblur="checkPhoneNumber()">
  <span class="error" id="PphoneErr"> <?php echo $PphoneErr;?></span><hr>
